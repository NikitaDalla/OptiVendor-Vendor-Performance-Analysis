# OptiVendor-Vendor-Performance-Analysis
OptiVendor: Vendor Performance Analysis is a data-driven analytics project that evaluates and compares vendor performance using key metrics, clustering, and anomaly detection to support informed procurement and decision-making.
...
Power BI Dashboard
Final insights PDF reportThis project focuses on analyzing vendor performance based on sales data. It involves data ingestion, cleaning, exploratory data analysis (EDA), automation of summary generation, and dashboard development using Power BI. The project concludes with a comprehensive report containing actionable insights.
